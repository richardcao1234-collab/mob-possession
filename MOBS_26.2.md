...
“已支持”表示可以被选中、附身、从其视角控制、移动、跳跃/游泳/飞行并使用统一近战。具有 `RangedAttackMob` 接口的实体还会走通用远程攻击分支；1.0.5 中骷髅系拥有沿玩家准星射箭的专用分支，远程生物会显示准星但不再绘制粒子预测轨迹；苦力怕、末影人、恶魂、守卫者、凋灵等实体也具有额外专用分支。并非每个生物都拥有独立右键技能。
